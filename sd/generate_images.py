...
if __name__ == "__main__":
    ...
    if(args.mode == "test"):
        ...
        pipe = StableDiffusionPipeline.from_pretrained(args.model_path, safety_checker=None).to(device)
        
        out = pipe(prompt=[args.prompt]*10, generator=gen)
        ...
        pipe = StableDiffusionPipeline.from_pretrained(args.model_path, torch_dtype=torch.float16, safety_checker=None).to(device)
